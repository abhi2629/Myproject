...
public class TransactionHistory extends javax.swing.JFrame {
    ...
    public TransactionHistory() {
        ...
        try {
            ...
            ResultSet rs=tableTransaction.executeQuery();
            while(rs.next()){
    ...
    private void initComponents() {
        ...
        Ttable.setBackground(new java.awt.Color(204, 204, 255));
        Ttable.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        Ttable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "sn", "account_number", "customer_name", "transaction_date", "transaction_type", "transaction_mode", "transaction_amount", "old_balance", "final_balance"
            }
        ) {
